...
def show_buttons_photo_need_yes_no(message: Message) -> None:
    """
    Вызов в чат онлайн-кнопок с вопросом - нужны ли пользователю фотографии?
...
def show_cities_buttons(message: Message, possible_cities: Dict) -> None:
    """
    Функция, из словаря возможных городов, формирует онлайн-клавиатуру с вариантами городов, и посылает её в чат.
   : param message : Message
